...
layout = dbc.Container(
    [
        html.Div(
            children=[
                html.H2("MultiQC report integration", style={"margin-top": 5}, className="display-4"),
                html.Hr(),
                ...
                dcc.Dropdown(
                    ...
                    id="sample-dropdown-multiqc",
                    style={"fontSize": 18, "font-family": "sans-serif"},
                    # multi=True,
                ),
                html.Br(),
                html.Iframe(
                    src=dash.get_asset_url("multiqc/multiqc_report.html"),
...
# @dash.callback(Output("sample-dropdown-multiqc", "value"), Input("sample-dropdown-multiqc", "options"))
