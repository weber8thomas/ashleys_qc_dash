...
listdir_counts = sorted(set([e.replace("-W.bigWig", "") for e in os.listdir("assets/Counts_BW") if e.endswith("-W.bigWig")]))[:10]
...
@dash.callback(Output("sample-dropdown-jbrowse", "value"), Input("sample-dropdown-jbrowse", "options"))
